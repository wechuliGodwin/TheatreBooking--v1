...
class TheatreRepository
{
    ...
    public function getBookingsByDateRange($startDate, $endDate, $query = null)
    {
        $sql = "
            SELECT
                a.SessionNumber,
        ...
        $params = [$startDate, date('Y-m-d', strtotime($endDate) + 86400)]; // Add one day to end date for < condition
