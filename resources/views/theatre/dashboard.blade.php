        ...
        <div class="card-body">
          <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1">
              ...
              <p class="card-text mb-1">Scheduled</p>
      ...
      <div class="card stat-card border-left-danger h-100">
        <div class="card-body">
          <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1">
              <h5 class="card-title mb-0">44K</h5>
              <p class="card-text mb-1">Inactive</p>
              <!-- <small class="text-danger"><i class="fas fa-arrow-down me-1"></i>23.6%</small> -->
            </div>
          </div>
        </div>
      ...
      <div class="card stat-card border-left-danger h-100">
        <div class="card-body">
          <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1">
              <h5 class="card-title mb-0">44K</h5>
              <p class="card-text mb-1">SHA Rejected</p>
              <!-- <small class="text-danger"><i class="fas fa-arrow-down me-1"></i>23.6%</small> -->
            </div>
          </div>
        </div>
      ...
      <div class="card stat-card border-left-danger h-100">
        <div class="card-body">
          <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1">
              <h5 class="card-title mb-0">44K</h5>
              <p class="card-text mb-1">Cancelled Appointments</p>
              <!-- <small class="text-danger"><i class="fas fa-arrow-down me-1"></i>23.6%</small> -->
            </div>
          </div>
        </div>
