                ...
                <div class="mb-3">
                    ...
                    <div class="row g-2">
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <input type="text" name="session_number" id="session_number" class="form-control form-control-sm {{ $surgery ? 'readonly-field' : '' }}" value="{{ old('session_number', $surgery->SessionNumber ?? '') }}" {{ $surgery ? 'readonly' : '' }}>
                        </div>
                        <div class="col-lg-3 col-md-6 col-12">
                            <label for="full_name" class="form-label small">Full Name</label>
                            <input type="text" name="full_name" id="full_name" class="form-control form-control-sm {{ $surgery ? 'readonly-field' : '' }}" value="{{ old('full_name', $surgery->PatientName ?? '') }}" {{ $surgery ? 'readonly' : '' }}>
                        </div>
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <div class="accordion-body">
                                <div class="row g-2">
                                    ...
                                    <!-- <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="booking_status" id="booking_status" class="form-control form-control-sm" value="{{ old('booking_status', $surgery->booking_status ?? $surgery->Status ?? '') }}">
                                    </div> -->
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="diagnosis" class="form-label small">Diagnosis</label>
                                        <input type="text" name="diagnosis" id="diagnosis" class="form-control form-control-sm" value="{{ old('diagnosis', $surgery->diagnosis ?? $surgery->PreferredName ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="date" name="proposed_date_of_surgery" id="proposed_date_of_surgery" class="form-control form-control-sm" value="{{ old('proposed_date_of_surgery', $surgery->proposed_date_of_surgery ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="date_of_surgery" class="form-label small">Date of Surgery</label>
                                        <input type="date" name="date_of_surgery" id="date_of_surgery" class="form-control form-control-sm" value="{{ old('date_of_surgery', $surgery->date_of_surgery ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="case_order" id="case_order" class="form-control form-control-sm" value="{{ old('case_order', $surgery->case_order ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="length_of_surgery" class="form-label small">Length of Surgery</label>
                                        <input type="text" name="length_of_surgery" id="length_of_surgery" class="form-control form-control-sm" value="{{ old('length_of_surgery', $surgery->length_of_surgery ?? '') }}" placeholder="e.g., 2 hours">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="notes_comments" class="form-label small">Notes/Comments</label>
                                        <textarea name="notes_comments" id="notes_comments" class="form-control form-control-sm" rows="2">{{ old('notes_comments', $surgery->notes_comments ?? '') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accordion-body">
                                <div class="row g-2">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="sha_procedure" id="sha_procedure" class="form-control form-control-sm" value="{{ old('sha_procedure', $surgery->sha_procedure ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="sha_code" class="form-label small">SHA Code</label>
                                        <input type="text" name="sha_code" id="sha_code" class="form-control form-control-sm" value="{{ old('sha_code', $surgery->sha_code ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="cpt_code" class="form-label small">CPT Code</label>
                                        <input type="text" name="cpt_code" id="cpt_code" class="form-control form-control-sm" value="{{ old('cpt_code', $surgery->cpt_code ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="sha_approved_amount" class="form-label small">SHA Approved Amount</label>
                                        <input type="number" name="sha_approved_amount" id="sha_approved_amount" class="form-control form-control-sm" value="{{ old('sha_approved_amount', $surgery->sha_approved_amount ?? '') }}" step="0.01" min="0">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="sha_expiry_date" class="form-label small">SHA Expiry Date</label>
                                        <input type="date" name="sha_expiry_date" id="sha_expiry_date" class="form-control form-control-sm" value="{{ old('sha_expiry_date', $surgery->sha_expiry_date ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="number" name="second_payer_approved_amount" id="second_payer_approved_amount" class="form-control form-control-sm" value="{{ old('second_payer_approved_amount', $surgery->second_payer_approved_amount ?? '') }}" step="0.01" min="0">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="date_deposit_paid" class="form-label small">Date Deposit Paid</label>
                                        <input type="date" name="date_deposit_paid" id="date_deposit_paid" class="form-control form-control-sm" value="{{ old('date_deposit_paid', $surgery->date_deposit_paid ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="deposit_amount" class="form-label small">Deposit Amount</label>
                                        <input type="number" name="deposit_amount" id="deposit_amount" class="form-control form-control-sm" value="{{ old('deposit_amount', $surgery->deposit_amount ?? '') }}" step="0.01" min="0">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="checkbox" name="sha_eligible" id="sha_eligible" class="form-check-input" {{ old('sha_eligible', $surgery->sha_eligible ?? false) ? 'checked' : '' }} value="1">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accordion-body">
                                <div class="row g-2">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="surgeon" id="surgeon" class="form-control form-control-sm" value="{{ old('surgeon', $surgery->surgeon ?? $surgery->Consultant ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="second_surgeon" class="form-label small">Second Surgeon</label>
                                        <input type="text" name="second_surgeon" id="second_surgeon" class="form-control form-control-sm" value="{{ old('second_surgeon', $surgery->second_surgeon ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="special_needs" id="special_needs" class="form-control form-control-sm" value="{{ old('special_needs', $surgery->special_needs ?? '') }}" placeholder="e.g., Wheelchair access">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="requires_anesthesia_clearance" class="form-label small">Requires Anesthesia Clearance</label>
                                        <input type="checkbox" name="requires_anesthesia_clearance" id="requires_anesthesia_clearance" class="form-check-input" {{ old('requires_anesthesia_clearance', $surgery->requires_anesthesia_clearance ?? false) ? 'checked' : '' }} value="1">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="anesthesia_clearance_notes" class="form-label small">Anesthesia Clearance Notes</label>
                                        <textarea name="anesthesia_clearance_notes" id="anesthesia_clearance_notes" class="form-control form-control-sm" rows="2">{{ old('anesthesia_clearance_notes', $surgery->anesthesia_clearance_notes ?? '') }}</textarea>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="icd10_code" id="icd10_code" class="form-control form-control-sm" value="{{ old('icd10_code', $surgery->icd10_code ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="appointment_id" id="appointment_id" class="form-control form-control-sm" value="{{ old('appointment_id', $surgery->appointment_id ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="entry_date" class="form-label small">Entry Date</label>
                                        <input type="date" name="entry_date" id="entry_date" class="form-control form-control-sm" value="{{ old('entry_date', $surgery->entry_date ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <div class="accordion-body">
                                <div class="row g-2">
                                    <div class="col-lg-3 col-md-6 col-12">
                                        ...
                                        <input type="text" name="cancellation_reason" id="cancellation_reason" class="form-control form-control-sm" value="{{ old('cancellation_reason', $surgery->cancellation_reason ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="cancellation_type" class="form-label small">Cancellation Type</label>
                                        <input type="text" name="cancellation_type" id="cancellation_type" class="form-control form-control-sm" value="{{ old('cancellation_type', $surgery->cancellation_type ?? '') }}">
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <label for="cancelled_at" class="form-label small">Cancelled At</label>
                                        <input type="date" name="cancelled_at" id="cancelled_at" class="form-control form-control-sm" value="{{ old('cancelled_at', $surgery->cancelled_at ?? '') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
