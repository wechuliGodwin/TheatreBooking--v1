...
<head>
    ...
    <style>
        ...
        .invalid-feedback { display: block; } /* Ensure errors show with Bootstrap */
    </style>
</head>
<body>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <!-- Display any general status messages (e.g., from password reset) -->
                    @if (session('status'))
                    ...
                    <form method="POST" action="{{ route('login.post') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="email" name="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" required>
                            @error('email')
